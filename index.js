...
import { HOUR_SEPERATOR_HINDI, HUNDREDS_IN_HINDI, MINUTES_IN_HINDI, MONTHS_TRANSLATION, NUMBERS_TRANSLATION, THOUSANDS_IN_HINDI } from './constants.js';
...
export function getHindiDates() {
    ...
    timeInHindi = `${formattedHours} ${HOUR_SEPERATOR_HINDI} ${minutes} ${MINUTES_IN_HINDI}`
